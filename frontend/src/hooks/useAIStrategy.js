...
export const useAIStrategy = (currentPrice, volatility, onStrikeUpdate) => {
    ...
    const fetchPrediction = useCallback(async () => {
        ...
        try {
            ...
            if (!health.model_loaded) throw new Error("Model not loaded");
            ...
            // Pass strike up to parent (App.jsx → StrategyMonitor)
            if (onStrikeUpdate && data.recommended_strike) {
                onStrikeUpdate(data.recommended_strike);
            }
    ...
    }, [currentPrice, volatility, onStrikeUpdate]);
